...
#read data
train1 = read.csv("C:\Users\jonfar\Documents\Research\GEFCOM2014\l5-train-fixed-date.csv")
train2 = data.frame(train1,dt=strptime(train1$Fixed_Timestamp,"%m/%d/%y %I:%M %p"),load=train1$LOAD,num=1:744)
