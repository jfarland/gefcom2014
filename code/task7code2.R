...
#read data
train1 = read.csv("C:\\Users\\ankgar\\Documents\\projects\\r\\load\\task7\\L7-train-fixed-timestamp.csv")
train2 = data.frame(train1,dt=strptime(train1$FIXED_TIMESTAMP,"%m/%d/%y %H:%M"),load=train1$LOAD,num=1:744)

train3_2 = train2[,5:31]
train3 = data.frame(train3_2[,1:24],load=train3_2$load)
