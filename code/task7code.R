...
#read data
train1 = read.csv("C:\\Users\\jonfar\\Documents\\Research\\GEFCOM2014\\training_data.csv")
train2 = data.frame(train1,dt=strptime(train1$DATETIME,"%m/%d/%y %I:%M %p"),load=train1$LOAD,num=1:89808)

#keep only the columns we want
train3_2 = train2[,9:36]


train3 = data.frame(train3_2[,1:28],load=train3_2$load)
...
dt2 = data.frame(dt=seq(dt1[nrow(dt1),1],by=3600,length.out=745))
dt3=rbind(dt1,dt2)
